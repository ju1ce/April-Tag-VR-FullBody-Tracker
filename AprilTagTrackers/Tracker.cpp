...
const cv::Mat3b COLORMAP_GREEN_TO_RED = []()
{
    // This colormap was created by converting a png file with 1x256 pixels like this:
    // cv::FileStorage fs("colormap.yml", cv::FileStorage::WRITE);
    // fs << "colormap" << cv::imread("colormap.png");
    static uint8_t colormapData[] = {
        0, 90, 18, 0, 90, 21, 0, 90, 24, 0, 90, 27, 0, 90, 29, 0, 90,
        31, 0, 90, 33, 0, 91, 35, 0, 91, 38, 0, 91, 39, 0, 91, 41, 0, 91,
        42, 0, 91, 44, 0, 91, 46, 0, 91, 48, 0, 91, 49, 0, 91, 51, 0, 91,
        52, 0, 91, 53, 0, 91, 55, 0, 91, 57, 0, 91, 58, 0, 91, 59, 0, 92,
        61, 0, 92, 62, 0, 92, 63, 0, 92, 64, 0, 92, 65, 0, 92, 67, 0, 92,
        69, 0, 92, 69, 0, 92, 71, 0, 92, 72, 0, 92, 73, 0, 92, 74, 0, 92,
        75, 0, 92, 76, 0, 92, 77, 0, 92, 79, 0, 92, 80, 0, 92, 81, 0, 92,
        82, 0, 92, 83, 0, 92, 84, 0, 92, 85, 0, 92, 86, 0, 92, 87, 0, 92,
        88, 0, 92, 90, 0, 92, 91, 0, 92, 92, 0, 92, 93, 0, 92, 94, 0, 92,
        95, 0, 92, 96, 0, 92, 97, 0, 92, 98, 0, 92, 99, 0, 92, 100, 0, 92,
        102, 0, 92, 102, 0, 92, 103, 0, 92, 104, 0, 92, 105, 0, 92, 106,
        0, 92, 107, 0, 92, 108, 0, 92, 109, 0, 92, 110, 0, 92, 112, 0, 92,
        112, 0, 92, 113, 0, 92, 114, 0, 92, 115, 0, 92, 116, 0, 92, 117,
        0, 92, 118, 0, 92, 119, 0, 92, 120, 0, 91, 121, 0, 91, 122, 0, 91,
        123, 0, 91, 124, 0, 91, 125, 0, 91, 126, 0, 91, 127, 0, 91, 127,
        0, 91, 128, 0, 91, 129, 0, 91, 130, 0, 91, 131, 0, 91, 132, 0, 91,
        134, 0, 91, 135, 0, 91, 135, 0, 91, 136, 0, 90, 137, 0, 90, 138,
        0, 90, 139, 0, 90, 140, 0, 90, 140, 0, 90, 141, 0, 90, 143, 0, 90,
        144, 0, 90, 145, 0, 89, 146, 0, 90, 146, 0, 90, 147, 0, 89, 148,
        0, 89, 149, 0, 89, 150, 0, 89, 151, 0, 89, 152, 0, 89, 152, 0, 89,
        154, 0, 89, 155, 0, 88, 156, 0, 88, 157, 0, 88, 158, 0, 88, 159,
        0, 88, 159, 0, 88, 160, 0, 88, 161, 0, 87, 162, 0, 87, 163, 0, 87,
        164, 0, 87, 165, 0, 87, 166, 0, 87, 167, 0, 86, 168, 0, 86, 169,
        0, 86, 169, 0, 86, 170, 0, 86, 171, 0, 86, 172, 0, 86, 173, 0, 86,
        173, 0, 85, 175, 0, 85, 176, 0, 85, 177, 0, 85, 178, 0, 84, 179,
        0, 84, 180, 0, 84, 180, 0, 84, 181, 0, 84, 182, 0, 84, 183, 0, 83,
        184, 0, 83, 184, 0, 83, 186, 0, 83, 187, 0, 83, 188, 0, 82, 189,
        0, 82, 190, 0, 82, 190, 0, 82, 191, 0, 81, 192, 0, 81, 193, 0, 81,
        194, 0, 80, 194, 0, 80, 195, 0, 80, 196, 0, 80, 198, 0, 79, 199,
        0, 79, 200, 0, 79, 200, 0, 79, 201, 0, 78, 202, 0, 78, 203, 0, 78,
        204, 0, 78, 205, 0, 77, 205, 0, 77, 206, 0, 77, 207, 0, 76, 209,
        0, 76, 210, 0, 76, 210, 0, 75, 211, 0, 75, 212, 0, 74, 213, 0, 74,
        214, 0, 74, 215, 0, 74, 215, 0, 73, 216, 0, 73, 217, 0, 73, 218,
        0, 72, 219, 0, 72, 220, 0, 71, 221, 0, 71, 222, 0, 70, 223, 0, 70,
        224, 0, 70, 225, 0, 69, 225, 0, 69, 226, 0, 69, 227, 0, 68, 228,
        0, 67, 229, 0, 67, 231, 0, 67, 231, 0, 66, 232, 0, 66, 233, 0, 65,
        234, 0, 65, 235, 0, 64, 235, 0, 64, 236, 0, 63, 237, 0, 62, 238,
        0, 62, 239, 0, 61, 240, 0, 61, 241, 0, 60, 242, 0, 60, 243, 0, 59,
        244, 0, 59, 245, 0, 58, 246, 0, 57, 246, 0, 56, 247, 0, 56, 248,
        0, 55, 249, 0, 55, 250, 0, 54, 251, 0, 53, 252, 0, 52, 253, 0, 52,
        254, 0, 51, 255, 0, 50, 255, 0, 49, 255, 0, 48, 255, 0, 48, 255,
        0, 47, 255, 0, 46, 255, 0, 45, 255, 0, 44, 255, 0, 43, 255, 0, 42,
        255, 0, 41, 255, 0, 40, 255, 0, 38, 255, 0, 37, 255, 0, 36, 255,
        0, 35, 255, 0, 33, 255, 0, 32, 255, 0, 30, 255, 0, 29, 255, 0, 27,
        255, 0, 25, 255, 0, 23, 255, 0, 21, 255, 0, 19, 255, 0, 16, 255,
        0, 13, 255, 0, 10, 255, 0, 6, 255, 0, 2, 255
    };
    return cv::Mat1b(256, 3, colormapData).reshape(3);
}();
    ...
    const std::vector<std::vector<int>>& allCharucoIds)
{
    ...
    if (allCharucoCorners.size() > 0)
    {
        ...
        if (!perViewErrors.empty())
        {
            ...
            cv::applyColorMap(colorsFromErrors, colorsFromErrors, COLORMAP_GREEN_TO_RED);
        }
