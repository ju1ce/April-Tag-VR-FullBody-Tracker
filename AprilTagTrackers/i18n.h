...
// temporary alias
#define T(arg_key, arg_uni_str)                        \
private:                                               \
    REFLECTABLE_VISITOR(_interface_, UniStr, arg_key); \
                                                       \
public:                                                \
    UniStr arg_key = arg_uni_str
...
public:
    ...
    T(CAMERA_START_CAMERA,
      "1. Start/Stop camera");
    T(CAMERA_CALIBRATE_CAMERA,
      "2. Calibrate camera");
    T(CAMERA_CALIBRATE_TRACKERS,
      "3. Calibrate trackers");
    T(CAMERA_START_STEAMVR,
      "4. Start up SteamVR!");
    T(CAMERA_CONNECT,
      "5. Connect to SteamVR");
    T(CAMERA_START_DETECTION,
      "6. Start/Stop");
    T(CAMERA_PREVIEW_CAMERA,
      "Preview camera");
    T(CAMERA_PREVIEW_CALIBRATION,
      "Preview calibration");
    T(CAMERA_CALIBRATION_MODE,
      "Calibration mode");
    T(CAMERA_MULTICAM_CALIB,
      "Refine calibration using second camera");
    T(CAMERA_LOCK_HEIGHT,
      "Lock camera height");
    ...
    T(CAMERA_DISABLE_OUT,
      "Disable out window");
    T(CAMERA_DISABLE_OPENVR_API,
      "Disable OpenVR API use");

    T(PARAMS_CAMERA_TOOLTIP_API_1,
      "0: No preference");
    T(PARAMS_CAMERA_TOOLTIP_API_2,
      "Camera backends:");
    T(PARAMS_CAMERA_TOOLTIP_API_3,
      "Stream backends:");
    ...
    T(PARAMS_CAMERA,
      "CAMERA PARAMETERS");
    T(PARAMS_CAMERA_NAME_ID,
      "Ip or ID of camera");
    T(PARAMS_CAMERA_TOOLTIP_ID,
      "Will be a number 0-10 for USB cameras and \nhttp://'ip - here':8080/video for IP webcam");
    T(PARAMS_CAMERA_NAME_API,
      "Camera API preference");
    T(PARAMS_CAMERA_NAME_ROT_CLOCKWISE,
      "Rotate camera clockwise");
    T(PARAMS_CAMERA_TOOLTIP_ROT_CLOCKWISE,
      "Rotate the camera 90°. Use both to rotate image 180°");
    T(PARAMS_CAMERA_NAME_ROT_CCLOCKWISE,
      "Rotate camera counterclockwise");
    T(PARAMS_CAMERA_TOOLTIP_ROT_CCLOCKWISE,
      "Rotate the camera 90°. Use both to rotate image 180°");
    T(PARAMS_CAMERA_NAME_WIDTH,
      "Camera width in pixels");
    T(PARAMS_CAMERA_TOOLTIP_WIDTH,
      "Width and height should be fine on 0, but change it to the camera resolution in case camera doesn't work correctly.");
    T(PARAMS_CAMERA_NAME_HEIGHT,
      "Camera height in pixels");
    T(PARAMS_CAMERA_TOOLTIP_HEIGHT,
      "Width and height should be fine on 0, but change it to the camera resolution in case camera doesn't work correctly.");
    T(PARAMS_CAMERA_NAME_FPS,
      "Camera FPS");
    T(PARAMS_CAMERA_TOOLTIP_FPS,
      "Set the fps of the camera");
    T(PARAMS_CAMERA_NAME_SETTINGS,
      "Open camera settings");
    T(PARAMS_CAMERA_TOOLTIP_SETTINGS,
      "Should open settings of your camera. Only works with Camera API preference DirectShow (700)");
    T(PARAMS_CAMERA_NAME_3_OPTIONS,
      "Enable last 3 camera options");
    T(PARAMS_CAMERA_TOOLTIP_3_OPTIONS,
    ...
    T(PARAMS_CAMERA_NAME_AUTOEXP,
      "Camera autoexposure");
    T(PARAMS_CAMERA_TOOLTIP_AUTOEXP,
    ...
    T(PARAMS_TRACKER_NAME_MARKER_LIBRARY,
      "Marker library");
    T(PARAMS_TRACKER_TOOLTIP_MARKER_LIBRARY,
      "Marker library to use. Leave at ApriltagStandard unless you know what you are doing.");
    T(PARAMS_TRACKER_NAME_USE_CENTERS,
      "Use centers of trackers");
    T(PARAMS_TRACKER_TOOLTIP_USE_CENTERS,
    ...
    T(PARAMS_SMOOTHING_NAME_ADDITIONAL,
      "Additional smoothing");
    T(PARAMS_SMOOTHING_TOOLTIP_ADDITIONAL,
    ...
    T(PARAMS_SMOOTHING_NAME_DEPTH,
      "Depth smoothing");
    T(PARAMS_SMOOTHING_TOOLTIP_DEPTH,
    ...
    T(PARAMS_SMOOTHING_NAME_CAM_LATENCY,
      "Camera latency");
    T(PARAMS_SMOOTHING_TOOLTIP_CAM_LATENCY,
    ...
    T(PARAMS_NOTE_LATENCY_GREATER_SMOOTHING,
    ...
    T(PARAMS_NOTE_2TRACKERS_IGNORE0,
    ...
    T(TRACKER_CAMERA_ERROR,
      "Camera error");
    T(TRACKER_CAMERA_PREVIEW,
      "Preview");

    T(TRACKER_CAMERA_NOTRUNNING,
      "Camera not running");
    ...
    T(TRACKER_CAMERA_CALIBRATION_COMPLETE,
      "Calibration complete.");
    T(TRACKER_CAMERA_CALIBRATION_NOTDONE,
      "Calibration has not been completed as too few images have been taken.");

    T(TRACKER_CAMERA_NOTCALIBRATED,
    ...
    T(TRACKER_TRACKER_NOTCALIBRATED,
      "Trackers not calibrated");

    T(TRACKER_STEAMVR_NOTCONNECTED,
      "Not connected to SteamVR");

    T(TRACKER_CALIBRATION_SOMETHINGWRONG,
      "Something went wrong. Try again.");
    T(CONNECT_SOMETHINGWRONG,
      "Something went wrong. Try again.");
    T(TRACKER_DETECTION_SOMETHINGWRONG,
